...
INSERT INTO items (name, description, category, location, filename, price, endDate, itemOwner) VALUES ("MetaBox Laptop", "Laptop that breaks", "Computers/Laptops", "Sydney", "unknown0.jpg", 1500, "7/11/2019", "xxx_abdo");
INSERT INTO items (name, description, category, location, filename, price, endDate, itemOwner) VALUES ("ESP8266", "TCP/IP stacked circuit", "IOT", "QLD", "unknown1.jpg", 25, "18/11/2019", "gimbo");
